...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Clínica Dental Dres. Mompeán | Dentista en Murcia" },
      {
        name: "description",
        content:
          "Clínica dental en el centro de Murcia con 5,0 estrellas en Google. Invisalign, estética dental, odontopediatría y urgencias. Pide tu cita en el 678 69 98 33.",
      },
      { name: "author", content: "Clínica Dental Dres. Mompeán" },
      { property: "og:site_name", content: "Clínica Dental Dres. Mompeán" },
