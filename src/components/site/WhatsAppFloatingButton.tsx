...
export function WhatsAppFloatingButton() {
  return (
    <a
      ...
      className="fixed bottom-5 left-5 z-50 flex size-14 items-center justify-center rounded-full bg-whatsapp shadow-soft transition-transform hover:scale-105"
    >
      <svg
        viewBox="0 0 24 24"
        aria-hidden="true"
        className="size-7 fill-primary-foreground"
        focusable="false"
      >
